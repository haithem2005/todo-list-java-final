...
public class Test3 {
    public static void main(String[] args) {
        ...
        System.out.println(taskArrayList.findTask("kartika").isStatusDone());
                    ...
                    case 1:
                        ...
                        switch (userInput3) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                System.out.println("enter a task title to be removed");
                                String removetask=scan.next();
                                taskArrayList.removeTask(removetask);
                            default:
